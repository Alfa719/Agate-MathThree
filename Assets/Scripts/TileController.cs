...
public class TileController : MonoBehaviour
{
    ...
    private static readonly Color selectedColor = new Color(0.5f, 0.5f, 0.5f), normalColor = Color.white;
    private static TileController previousSelected = null;
    private bool isSelected = false;

    private static readonly float moveDuration = 0.5f, destroyBigDuration = 0.1f, destroySmallDuration = 0.4f;

    private static readonly Vector2 sizeBig = Vector2.one * 1.2f, sizeSmall = Vector2.zero, sizeNormal = Vector2.one;
